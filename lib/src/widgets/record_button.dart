...
import 'package:voice_chat/src/audio_state.dart';
import 'package:voice_chat/src/globals.dart';
import 'package:voice_chat/src/widgets/flow_shader.dart';
import 'package:voice_chat/src/widgets/lottie_animation.dart';
...
class _RecordButtonState extends State<RecordButton> {
  ...
  bool isCancelled(Offset offset, BuildContext context) {
    return (offset.dx < -(MediaQuery.of(context).size.width * 0.1));
  }
}
